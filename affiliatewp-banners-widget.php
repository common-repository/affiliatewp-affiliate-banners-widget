...
final class AffiliateWP_Banners_Widget {
	...
	public function load_plugin_textdomain() {
		...
		if ( file_exists( $mofile_global ) ) {
			// Look in global /wp-content/languages/affiliatewp-affiliate-banners-widget/ folder
			load_textdomain( self::text_domain, $mofile_global );
		}
		elseif ( file_exists( $mofile_local ) ) {
			// Look in local /wp-content/plugins/affiliatewp-affiliate-banners-widget/languages/ folder
